...
interface UseSemanticModelQueryOptions {
    ...
    bypassCache?: boolean;
    /** Changing this value forces the query to execute again. */
...
export function useSemanticModelQuery(
    ...
    const { connection, query, bypassCache, refreshKey } = options;
    ...
    }, [connection, query, bypassCache, canExecute, refreshKey]);
